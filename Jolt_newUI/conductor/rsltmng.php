		...
		s.sid=st.sid and st.testid=".$_REQUEST['testid']."";
                    ...
                    <table class="table table-striped" cellpadding="30" cellspacing="10" class="datatable">
                        ...
                        <tr>
                          ...
                          <?php echo "<td class=\"tddata\"><a title=\"Details\" href=\"viewresult.php?details=".$_REQUEST['testid']."&stdid=".$r1['sid']."\"><img src=\"../img/detail.png\" height=\"30\" width=\"40\" alt=\"Details\" /></a></td>";?>
            ...
            <?php
                                    while($r=mysqli_fetch_array($result)) {
                                        ...
                                        echo "<td>".htmlspecialchars_decode($r['testname'],ENT_QUOTES)."</td><td>".$r['fromdate']." To ".$r['todate']." PM </td><td>".htmlspecialchars_decode($r['cid'],ENT_QUOTES)."</td><td>"
                                            ...
                                            ."<td class=\"tddata\"><a title=\"Details\" href=\"rsltmng.php?testid=".$r['testid']."\"><img src=\"../img/detail.png\" height=\"30\" width=\"40\" alt=\"Details\" /></a></td>"
