...
printpage.document.write('<html><head><title>Exam Report</title><link rel="stylesheet" type="text/css" href="../css/bootstrap.min.css" /></head>');
...
printpage.focus();
							 ...
							 <?php 
			echo '<h3> List Of All Student Currently registered For Following Course<br><br></h3>';

			echo '<h4> Course ID: ' . $cid . '<br></h4>';
			echo '<h4> Course Name: ' . $row1['cname'] . '<br></h4>';
			echo '<h4> Semester: ' . $sem . '<br></h4>';
			echo '<h4> Year: ' . $year . '<br><br></h4>';
			...
			echo '</div>';
			echo '</div>';
			echo '<div class="container"><input type="button" value="Print Preview" class="subbtn" onClick="javascript:window.print()">';
			?>
...
<h2>Student Data Information Form</h2><br>
