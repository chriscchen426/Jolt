            ...
            <form action="testopconducter.php" method="post">
             ...
             <tr><td>&nbsp;</td></tr>
              ...
              <table class="table table-hover">
                  ...
                  <tr>
                      <th style="width:80%;"><h4><input type="submit" name="<?php if($final==true){ echo "viewsummary" ;}else{ echo "next";} ?>" value="<?php if($final==true){ echo "View Summary" ;}else{ echo "Next";} ?>" class="subbtn"/>
                      <input type="submit" name="previous" value="Previous" class="subbtn"/>
                      <input type="submit" name="summary" value="Summary" class="subbtn"/></h4></th>
                  </tr>
